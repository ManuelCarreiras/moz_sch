...
class TestTeacherImport(unittest.TestCase):
    ...
    def test_import_teachers_no_file(self):
        """Test importing teachers without file"""
        response = self.client.post('/teacher/import',
